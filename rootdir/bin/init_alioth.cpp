...
void load_redmi_k40() {
    ...
    property_override("ro.build.description", "alioth-user 12 SKQ1.211006.001 V13.0.9.0.SKHCNXMrelease-keys");
}
...
void load_poco_f3() {
    ...
    property_override("ro.build.description", "alioth_global-user 12 SKQ1.211006.001 V13.0.6.0.SKHMIXMrelease-keys");
}
